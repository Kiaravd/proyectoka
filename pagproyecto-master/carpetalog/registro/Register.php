...
<body>
  ...
  <div class="register-box">
    ...
    <button onclick="registrar(document.getElementById('registerEmail').value, document.getElementById('registerPassword').value)"  type="button" class="confirmar">Continuar</button>


    <a href="../login/login.html" type="submit" class="cuenta">¿Ya tienes una cuenta?</a>
